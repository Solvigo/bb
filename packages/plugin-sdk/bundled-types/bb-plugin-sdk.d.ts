...
declare const threadEventSchema: z$1.ZodPipe<z$1.ZodUnknown, z$1.ZodUnion<readonly [z$1.ZodIntersection<z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
    ...
    origin: z$1.ZodOptional<z$1.ZodEnum<{
        "operator-steer": "operator-steer";
        "crew-tasking": "crew-tasking";
    }>>;
...
declare const skillListResponseSchema: z$1.ZodObject<{
    skills: z$1.ZodArray<z$1.ZodObject<{
        ...
        publishGlobally: z$1.ZodBoolean;
    }, z$1.core.$strip>>;
}, z$1.core.$strip>;
...
declare const installedPluginSchema: z$1.ZodObject<{
    ...
    frontendError: z$1.ZodDefault<z$1.ZodNullable<z$1.ZodObject<{
        message: z$1.ZodString;
        at: z$1.ZodNumber;
    }, z$1.core.$strip>>>;
}, z$1.core.$strip>;
...
declare const systemVersionResponseSchema: z$1.ZodObject<{
    ...
    upgradeCommand: z$1.ZodOptional<z$1.ZodString>;
    managed: z$1.ZodOptional<z$1.ZodBoolean>;
}, z$1.core.$strip>;
...
type PluginAgentSurfaceViewerRole = "commander" | "lead" | "sortie";
interface PluginAgentSurfaceTabProps {
    /**
...
interface PluginAgentSurfaceTabRegistration {
    /** Unique within the plugin; letters, digits, `-`, `_`. */
    id: string;
...
interface PluginAppSlots {
     ...
     * Experimental: see docs/api_to_audit.md.
     */
    experimental_agentSurfaceTab(registration: PluginAgentSurfaceTabRegistration): void;
...
interface SkillPublishGloballyArgs extends SkillWorkspaceArgs {
    skillId: string;
...
interface SkillsArea {
    ...
    setPublishGlobally(args: SkillPublishGloballyArgs): Promise<{
        publishGlobally: boolean;
    }>;
